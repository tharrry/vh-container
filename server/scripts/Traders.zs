...
craftingTable.addShaped("easy_piglin_barterer", <item:easy_piglins:barterer>, [
    ...
    [<item:minecraft:tinted_glass>, <item:compressium:gold_1>, <item:minecraft:tinted_glass>],
...
craftingTable.addShaped("easy_trader", <item:easy_villagers:trader>, [
    [<item:minecraft:tinted_glass>, <item:minecraft:tinted_glass>, <item:minecraft:tinted_glass>],
    [<item:minecraft:tinted_glass>, <item:compressium:redstone_1>, <item:minecraft:tinted_glass>],
...
craftingTable.addShaped("easy_farmer", <item:easy_villagers:farmer>, [
    [<item:minecraft:tinted_glass>, <item:minecraft:tinted_glass>, <item:minecraft:tinted_glass>],
    [<item:minecraft:tinted_glass>, <item:minecraft:water_bucket>, <item:minecraft:tinted_glass>],
    [<item:the_vault:chromatic_iron_ingot>, <item:compressium:dirt_4>, <item:the_vault:chromatic_iron_ingot>]
]);
...
craftingTable.addShaped("easy_iron_farm", <item:easy_villagers:iron_farm>, [
    ...
    [<item:the_vault:chromatic_steel_ingot>, <item:compressium:stone_4>, <item:the_vault:chromatic_steel_ingot>]
]);